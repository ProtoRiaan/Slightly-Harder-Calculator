...
def main(): #Controls the flow of the program (calls the other modules). This includes decision logic (such as while True, if/elif/else) to call functions as requested. 
    while True:
        ...
        userOutput(value1,value2,result,operator)
...
def add(validCompNumber1,validCompNumber2): #Accepts two numbers, returns the sum
    addFunctionresult=validCompNumber1+validCompNumber2
...
def subtract(validCompNumber1,validCompNumber2): #Accepts two numbers, returns the difference of the first number minus the second number
    subtractFunctionResult=validCompNumber1-validCompNumber2
    return subtractFunctionResult
...
def userOutput(value1,value2,result,operator): #Gives a user friendly output of the selected calculation. HINT: make your code reusable so that this method contains no decision structure!
    pass
